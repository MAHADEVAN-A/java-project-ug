...
import java.util.*;
import javax.swing.*;
public class MyRemoteServic extends UnicastRemoteObject implements MyRemot , Serializable
{
	public MyRemoteServic() throws RemoteException { }
...
public Object[] getChartData(String a[],int a1)
	...
	public Object[] getImages(String sid[],int cc)
	{
		...
		//Image img[] =new Image[r3.length];
		Object oo[] = new Object[r3.length];
		//img[0] = Toolkit.getDefaultToolkit().getImage(r3[0]);
		
			ImageIcon ic[] = new ImageIcon[r3.length];
		   for(int i=0;i<r3.length;i++)
		   {
			ic[i] = new ImageIcon(r3[i]);
			oo[i] =(Object) ic[i];
		   }
		   return oo;
	}
	...
	public static void main(String args[])
	{
		try
		{
			MyRemot service = new MyRemoteServic();
