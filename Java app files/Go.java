...
import javax.swing.table.*;
  public class Go extends JWindow {
   Image splashScreen;
   ImageIcon imageIcon;
   public Go() {
    ...
    c.add("North",b1);
	 ...
	 try 
		{	  
         ...
         r3 = service.getImages(a,vcount);
		  img =new Image[r3.length];
		   for(int i=0;i<r3.length;i++)
		   {
			img[i] = Toolkit.getDefaultToolkit().getImage(r3[i]);
		   }
