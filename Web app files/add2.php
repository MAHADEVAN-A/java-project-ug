...
switch($tg)
{
	case "mcsc": $y[1]="P0001";break;
	case "mmat": $y[1]="P0002";break;
	case "mphy": $y[1]="P0003";break;
	case "mche": $y[1]="P0004";break;
	case "mzoo": $y[1]="P0005";break;
	case "mbot": $y[1]="P0006";break;
	case "mtam": $y[1]="P0007";break;
	case "meng": $y[1]="P0008";break;
	case "mbcs": $y[1]="P0009";break;
	case "mbca": $y[1]="P0010";break;
}
...
$sql2 = 'INSERT INTO UGMARKDETAIL VALUES(\''.$id.'\',\''.$y[0].'\',\''.$y[1].'\',\''.$coll.'\',\''.$univ.'\',\''.$year.'\','.$avg.','.$stream.')';
